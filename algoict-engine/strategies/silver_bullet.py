...
class SilverBulletStrategy:
    ...
    def evaluate(
        ...
        # 2026-05-18 — Confluence gate experiments (SB_REQUIRE_HTF_BIAS,
        # SB_MIN_LIVE_CONFLUENCE) both REJECTED after 3-year cross-period
        # A/B (see CLAUDE.md §"Silver Bullet sub-score"). Score=0 is the
        # highest-WR bucket cross-year, not noise. No confluence gate is
        # active. If reopened: gate logic was a simple
